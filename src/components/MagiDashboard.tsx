  ...
  return (
    <div className="bg-[#050505] text-[#FF3300] border-1 border-[#FF9900] font-mono p-4">
      ...
      <div className="space-y-2">
        <div data-testid="melchior" className={magiVotes.melchior ? 'text-[#FF3300]' : 'text-[#FF9900]'}>
          MELCHIOR-1: {magiVotes.melchior ? 'APPROVE' : 'REJECT'}
        </div>
        <div data-testid="balthasar" className={magiVotes.balthasar ? 'text-[#FF3300]' : 'text-[#FF9900]'}>
          BALTHASAR-2: {magiVotes.balthasar ? 'APPROVE' : 'REJECT'}
        </div>
        <div data-testid="casper" className={magiVotes.casper ? 'text-[#FF3300]' : 'text-[#FF9900]'}>
          CASPER-3: {magiVotes.casper ? 'APPROVE' : 'REJECT'}
        </div>
      </div>
      <div
        data-testid="consensus"
        className={`mt-4 text-lg font-bold ${consensus ? 'text-[#FF3300]' : 'text-[#FF9900]'}`}
      >
